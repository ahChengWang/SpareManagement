...
/****** Object:  Table [dbo].[WirePanel]    Script Date: 2022/5/31 ¤W¤È 09:39:18 ******/
SET ANSI_NULLS ON
GO
...
CONSTRAINT [PK_wirepanel] PRIMARY KEY CLUSTERED 
(
...
CREATE INDEX idx_wirepanel_1
ON WirePanel(PartNo,Name,SerialNo,Status,PurchaseId,NextInspectDate);
