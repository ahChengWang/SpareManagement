...
namespace SpareManagement.DomainService
{
    public interface IWirePanelDomainService
    {
        ...
        (string, int) ProcessRelease(IEnumerable<ReleaseGoodsEntity> releaseWirePanelList, string createUser, DateTime? createDate, string memo, DateTime nowTime, UserEntity userEntity);
